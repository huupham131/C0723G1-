  ...
  <table class="table">
    ...
    <c:forEach items="${serviceList}" var="service" varStatus="loop">
      <tr>
        ...
        <td class="padding">${service.getName()}</td>
        <td class="padding">${service.getPrice()}</td>
        <td class="padding">${service.getUnit()}</td>
        ...
        <td>
          <button type="button" style="border: none"
                  ...
                  onclick="modalDelete('${service.getId()}','${service.getName()}')">
