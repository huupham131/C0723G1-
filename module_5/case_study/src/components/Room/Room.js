        ...
        <>
            ...
            <section className="section">
                <div className="container">
                    <div>
                        <Link className="btn btn-primary text-white" to={"/addRoom"}>Thêm mới phòng</Link>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                            <Link to="#" className="room">
                                ...
                                <div className="p-3 text-center room-info">
                                    ...
                                    <button className="btn btn-danger text-white" data-bs-toggle="modal"
                        ...
                        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                            <Link to="#" class="room">
                                ...
                                <div class="p-3 text-center room-info">
                                    ...
                                    <Link class="btn btn-primary text-white" to={"/editRoom"}>Sừa</Link>
